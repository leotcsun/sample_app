...
describe UsersController do
  ...
  describe 'GET index' do
    ...
    describe 'for signed-in users' do
      ...
      it 'should have delete links for non-admins' do
        other_user = User.all.second
        get :index
  ...
  describe "GET 'show'" do
    ...
    it 'should have the name of user' do
      get :show, :id => @user
    ...
    it 'should show the users microposts' do
      ...
      mp2 = Factory(:micropost, :user => @user, :content => 'Foo bar mp2')
      get :show, :id => @user
  ...
  describe 'POST create' do
    ...
    describe 'success' do
      ...
      it 'should redirect to the user shpw page' do
        post :create, :user => @attr
  ...
  describe 'DELETE destroy'  do
    ...
    describe 'as an admin user' do
      ...
      before(:each) do
        @admin = Factory(:user, :email => 'admin@sampleapp.com', :admin => true)
        test_sign_in(@admin)
      end
  ...
  describe "follow pages" do
    describe "should protect following" do
      it "shouuld protect following" do
        get :following, :id => 1
        response.should redirect_to(signin_path)
      end
